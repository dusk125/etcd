...
### Go
- Require [Go 1.22+](https://github.com/etcd-io/etcd/pull/17393).
- Compile with [Go 1.22+](https://go.dev/doc/devel/release#go1.22.minor). Please refer to [gc-guide](https://go.dev/doc/gc-guide) to configure `GOGC` and `GOMEMLIMIT` properly. 
