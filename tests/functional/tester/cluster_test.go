		...
		Members: []*rpcpb.Member{
			{
				...
				BaseDir:            "/Users/mustafa/workspace/go/src/etcd/etcd/test-temp/etcd-functional-1",
				EtcdClientProxy:    false,
				EtcdPeerProxy:      true,
				EtcdClientEndpoint: "127.0.0.1:1379",
				Etcd: &rpcpb.Etcd{
					Name:                "s1",
					DataDir:             "/Users/mustafa/workspace/go/src/etcd/etcd/test-temp/etcd-functional-1/etcd.data",
					WALDir:              "/Users/mustafa/workspace/go/src/etcd/etcd/test-temp/etcd-functional-1/etcd.data/member/wal",
					...
					Logger:              "zap",
					LogOutputs:          []string{"/Users/mustafa/workspace/go/src/etcd/etcd/test-temp/etcd-functional-1/etcd.log"},
					LogLevel:            "info",
				...
				PeerTrustedCAData:   "",
				PeerTrustedCAPath:   "",
				SnapshotPath:        "/Users/mustafa/workspace/go/src/etcd/etcd/test-temp/etcd-functional-1.snapshot.db",
			},
			{
				EtcdExec:           "./bin/etcd",
				AgentAddr:          "127.0.0.1:29027",
				FailpointHTTPAddr:  "http://127.0.0.1:7382",
				BaseDir:            "/Users/mustafa/workspace/go/src/etcd/etcd/test-temp/etcd-functional-2",
				EtcdClientProxy:    false,
				EtcdPeerProxy:      true,
				EtcdClientEndpoint: "127.0.0.1:2379",
				Etcd: &rpcpb.Etcd{
					Name:                "s2",
					DataDir:             "/Users/mustafa/workspace/go/src/etcd/etcd/test-temp/etcd-functional-2/etcd.data",
					WALDir:              "/Users/mustafa/workspace/go/src/etcd/etcd/test-temp/etcd-functional-2/etcd.data/member/wal",
					HeartbeatIntervalMs: 100,
					ElectionTimeoutMs:   1000,
					...
					InitialCorruptCheck: true,
					Logger:              "zap",
					LogOutputs:          []string{"/Users/mustafa/workspace/go/src/etcd/etcd/test-temp/etcd-functional-2/etcd.log"},
					LogLevel:            "info",
					SocketReuseAddress:  true,
					SocketReusePort:     true,
				},
				...
				PeerTrustedCAData:   "",
				PeerTrustedCAPath:   "",
				SnapshotPath:        "/Users/mustafa/workspace/go/src/etcd/etcd/test-temp/etcd-functional-2.snapshot.db",
			},
			{
				EtcdExec:           "./bin/etcd",
				AgentAddr:          "127.0.0.1:39027",
				FailpointHTTPAddr:  "http://127.0.0.1:7383",
				BaseDir:            "/Users/mustafa/workspace/go/src/etcd/etcd/test-temp/etcd-functional-3",
				EtcdClientProxy:    false,
				EtcdPeerProxy:      true,
				EtcdClientEndpoint: "127.0.0.1:3379",
				Etcd: &rpcpb.Etcd{
					Name:                "s3",
					DataDir:             "/Users/mustafa/workspace/go/src/etcd/etcd/test-temp/etcd-functional-3/etcd.data",
					WALDir:              "/Users/mustafa/workspace/go/src/etcd/etcd/test-temp/etcd-functional-3/etcd.data/member/wal",
					HeartbeatIntervalMs: 100,
					ElectionTimeoutMs:   1000,
					...
					InitialCorruptCheck: true,
					Logger:              "zap",
					LogOutputs:          []string{"/Users/mustafa/workspace/go/src/etcd/etcd/test-temp/etcd-functional-3/etcd.log"},
					LogLevel:            "info",
					SocketReuseAddress:  true,
					SocketReusePort:     true,
				},
				...
				PeerTrustedCAData:   "",
				PeerTrustedCAPath:   "",
				SnapshotPath:        "/Users/mustafa/workspace/go/src/etcd/etcd/test-temp/etcd-functional-3.snapshot.db",
			},
		},
		Tester: &rpcpb.Tester{
			DataDir:               "/Users/mustafa/workspace/go/src/etcd/etcd/test-temp/etcd-tester-data",
			Network:               "tcp",
			Addr:                  "127.0.0.1:9028",
			DelayLatencyMs:        5000,
